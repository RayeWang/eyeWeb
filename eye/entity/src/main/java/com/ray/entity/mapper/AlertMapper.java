...
public interface AlertMapper {
    ...
    @Insert({
        ...
        "#{hot,jdbcType=INTEGER}, #{createtime,jdbcType=TIMESTAMP}, ",
        "#{alerttime,jdbcType=VARCHAR}, #{param1,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, title, desc1, url, res_link_id, res_id, atype_id, hot, createtime, alerttime, ",
        "param1, param2, param3, param4, param5, content",
        "from alert",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({

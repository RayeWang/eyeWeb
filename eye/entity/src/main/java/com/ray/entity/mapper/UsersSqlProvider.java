...
import com.ray.entity.UsersCriteria.Criteria;
import com.ray.entity.UsersCriteria.Criterion;
...
public class UsersSqlProvider {
    ...
    public String insertSelective(Users record) {
        ...
        if (record.getDisabled() != null) {
            VALUES("disabled", "#{disabled,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getDisabled() != null) {
            SET("disabled = #{record.disabled,jdbcType=INTEGER}");
        }
     ...
     * @mbggenerated
     */
    protected void applyWhere(UsersCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
